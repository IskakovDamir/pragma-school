...
const SLOTS: Record<Stage, Record<BubbleKey, Slot>> = {
  idle: {
    c1: { top: "78%", opacity: 0 },
    bot: { top: "78%", opacity: 0 },
    c2: { top: "78%", opacity: 0 },
    slack: { top: "42%", opacity: 0 },
    amo: { top: "76%", opacity: 0 },
  },
  "client-easy": {
    c1: { top: "78%", opacity: 1 },
    bot: { top: "78%", opacity: 0 },
  ...
  "escalate-toasts": {
    ...
    slack: { top: "42%", opacity: 1 },
    amo: { top: "76%", opacity: 1 },
  },
  hold: {
    c1: { top: "8%", opacity: 0 },
    bot: { top: "56%", opacity: 0 },
